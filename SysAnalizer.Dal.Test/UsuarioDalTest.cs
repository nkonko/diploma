namespace SysAnalizer.Dal.Test
{
    ...
    public class UsuarioDalTest
    {
        ...
        {
            Usuario.Crear(new BE.Usuario { Nombre = "LALA", Apellido = "peppe", Contraseña = "123456", Email = "lala@hotmail.com", Telefono = 46532, PrimerLogin = true, IdIdioma = 1, CIngresos = 1, Activo = true, IdCanalVenta = 1 });
            Assert.True(true);
        }
    }
}
